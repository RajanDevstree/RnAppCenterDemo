...
const App = () => {
  ...
  useEffect(() => {
    codePush.sync(
      {
        deploymentKey: codePushVersion['ios-Staging'],
        updateDialog: true,
  ...
  return (
    <SafeAreaView
      style={{flex: 1, backgroundColor: 'blue', marginHorizontal: 6}}>
      ...
      <View
        style={{justifyContent: 'center', alignItems: 'center', marginTop: 30}}>
        <Text style={{fontSize: 18, fontWeight: 'bold', textAlign: 'center'}}>
          Changes: 1 codepush upload and background color green and header image
          change
        </Text>
      </View>
    </SafeAreaView>
